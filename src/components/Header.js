...
const Header = () => {
  return (
    ...
    <nav class="side-nav">
      <ul>
        <li>
          <a href="#about-menu" id="about-menu">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="#projects-menu" id="projects-menu">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 96 960 960"
              height="24"
        ...
        <li class="contact-menu">
          <a href="#contact-btn" id="contact-btn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 96 960 960"
              height="24"
          ...
          <div class="contact-menu__dropdown">
            ...
            <a href="mailto:aris.hadisopiyan@gmail.com" id="contact-email">
              <span>aris.hadisopiyan@gmail.com</span>
            </a>
            <div class="seperator">
              <div class="line"></div>
            ...
            <ul class="social-icons">
              <li>
                <a
                  href="https://www.facebook.com/aris.hadisopiyan"
                  target="_blank"
                  rel="noreferrer noopener"
                >
                  <svg
              ...
              <li>
                <a
                  href="https://www.youtube.com/channel/UCc-wxj8LR7n83Y_-6fGwnKA"
                  target="_blank"
                  rel="noreferrer noopener"
                >
                  <svg
              ...
              <li>
                <a
                  href="https://www.instagram.com/aris.hadisopiyan"
                  target="_blank"
                  rel="noreferrer noopener"
                >
                  <svg
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/arishadisopiyan"
                  target="_blank"
                  rel="noreferrer noopener"
                >
                  <svg
